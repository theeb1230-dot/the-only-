...
| Sixth section | source #14 from archive manifest | `a92d63c0a542ba37370bb14a026b5cc227e1165d` | recursive exact-SHA tree contains no LICENSE/NOTICE; README does not grant a license | REFERENCE_ONLY | clean-room behavior only; no source copying; local feature gate remains disabled by default |
