...
void main() {
  test('search keeps only Creative Commons/public-domain records', () async {
    late Uri requested;
  ...
  test('sources expose direct MP4 after license re-check', () async {
    final provider = InternetArchiveProvider(fetchJson: (uri) async {
  ...
  test('sources fail closed when rights are not explicitly open', () async {
